...
[ ] R19: In Model settings, make a checkbox to configure different settings for the Editor. When checked, display a second set of parameters + max tokens + reasoning effort for the Editor.
