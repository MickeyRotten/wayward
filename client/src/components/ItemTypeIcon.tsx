...
export function ItemTypeIcon({ type, className, title }: { type?: string; className?: string; title?: string }) {
  const common = {
  ...
  switch (type) {
    case 'Equipment': // shield
      return <svg {...common}>{tip}<path d="M12 3l7 3v5c0 4.4-3 7.6-7 9-4-1.4-7-4.6-7-9V6l7-3z" /></svg>
    case 'Tool': // wrench
      return <svg {...common}>{tip}<path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 0 5.4-5.4l-2.7 2.7-2-2 2.7-2.7z" /></svg>
    case 'Consumable': // flask
      return <svg {...common}>{tip}<path d="M9 3h6M10 3.5v4.6L5.6 16a2 2 0 0 0 1.8 3h9.2a2 2 0 0 0 1.8-3L14 8.1V3.5" /><path d="M7.5 14h9" /></svg>
    case 'Key Item': // key
